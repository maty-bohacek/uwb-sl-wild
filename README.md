...
> [Data](https://huggingface.co/datasets/matybohacek/uwb-wild) — [Paper](https://arxiv.org/abs/2301.03769) — [Contact us](mailto:maty@stanford.edu)
>
> *Pre-print. Under review.*

<br>

- The dataset is distributed via [Hugging Face](https://huggingface.co/datasets/matybohacek/uwb-wild).
